...
import PaymentModal from "@components/admin/ban-hang/PaymentModal";
import NumericKeypad from "@components/admin/ban-hang/NumericKeypad";
import PriceEditModal from "@components/admin/ban-hang/PriceEditModal";
      ...
      {isPaymentModalVisible && (
        <PaymentModal
          ...
          cartSummary={{
            ...
            totalAmount: cart.reduce(
              (sum, item) =>
                sum + (item.soldPrice || item.price) * item.quantity,
              0,
            ),
          }}
        />
...
export default MobileMainSellingPage;
